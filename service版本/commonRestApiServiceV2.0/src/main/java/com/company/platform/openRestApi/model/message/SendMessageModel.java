 ...
 *
 *    Filename:    SendMessageModel.java
 *
...
/** 
* @ClassName: SendMessageModel 
* @Description: TODO(发送短信通知) 
* @author zhengjn 
* @date 2017年11月6日 上午11:31:04 
*  
*/
@SuppressWarnings("serial")
public class SendMessageModel extends BaseHttpParamsAppReq {
