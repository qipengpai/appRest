...
/**
 * @ClassName: LoanProductApplyStorage
 * @Description: TODO(借贷申请存储信息结果集)
 * @author wangxue
 * @date 2018年8月14日 下午4:38:00
 * 
 */
@SuppressWarnings("all")
public class LoanProductApplyStorage extends BaseHttpParamsAppReq {
