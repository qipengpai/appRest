 ...
 * 
 */
public class SignValidatorImpl implements ConstraintValidator<Sign, BaseHttpParamsAppReq> {
    ...
    @Override
    public boolean isValid(BaseHttpParamsAppReq value, ConstraintValidatorContext context) {
        // TODO Auto-generated method stub
        if (null == value) {
            return false;
        }
